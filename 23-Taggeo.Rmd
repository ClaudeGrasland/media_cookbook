...
qd <- extract_tags (qd = qd,
                   ...
                   split = c("'","’","-"),
                     tolow = FALSE)
saveRDS(qd,"quanteda/ar_TUN_babnet_geo.RDS")
qd11<-qd
table(qd$nbtags)
x<-data.frame(text=as.character(qd),tags=qd$tags,nbtags=qd$nbtags)
```
...
qd <- extract_tags (qd = qd,
                   ...
                   split = c("'","’","-"),
                     tolow = FALSE)
saveRDS(qd,"quanteda/fr_TUN_realit_geo.RDS")
qd12<-qd
table(qd$nbtags)
x<-data.frame(text=as.character(qd),tags=qd$tags,nbtags=qd$nbtags)
```
...
qd <- extract_tags (qd = qd,
                   ...
                   split = c("'","’","-"),
                     tolow = FALSE)
saveRDS(qd,"quanteda/fr_TUN_ecomag_geo.RDS")
qd13<-qd
table(qd$nbtags)
x<-data.frame(text=as.character(qd),tags=qd$tags,nbtags=qd$nbtags)
```
...
qd <- extract_tags (qd = qd,
                   ...
                   split = c("'","’","-"),
                     tolow = FALSE)
saveRDS(qd,"quanteda/fr_TUN_presse_geo.RDS")
qd14<-qd
table(qd$nbtags)
x<-data.frame(text=as.character(qd),tags=qd$tags,nbtags=qd$nbtags)
```
...
saveRDS(qd,"quanteda/corpus_worldgeo_001.RDS")
table(qd$nbtags)
```
