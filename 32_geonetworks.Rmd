...
Now we extract the network of preferential links for each country separately, which is a good way to indify problems in the dictionary.
...
hc<-hc_filter(don = hc_sta_reg,
              where1 = "label1",
              where2 = "label2",
             who_inc = c("en_GBR_guardi", "en_GBR_telegr"),
              wgt = "tags",
              where2_exc = c("_no_"),
              self = FALSE
)
...
hc<-hc_filter(don = hc_sta_reg,
              where1 = "label1",
              where2 = "label2",
             who_inc = c( "en_NIR_beltel", "en_IRL_irtime"),
              wgt = "tags",
              where2_exc = c("_no_"),
              self = FALSE
)
...
hc<-hc_filter(don = hc_sta_reg,
              where1 = "label1",
              where2 = "label2",
             who_inc = c("fr_DZA_elwata", "ar_DZA_alnaha", "ar_DZA_chorou"),
              wgt = "tags",
              where2_exc = c("_no_"),
              self = FALSE
)
