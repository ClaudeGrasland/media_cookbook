...
We start from a provisional list of 65 world regions + 45 regional organisations established by C. Grasland :

```{r}
ent<-read.table("dict/wikireg_V3.csv", 
                sep=";",
                header=T,
                encoding = "UTF-8")
```
...
write.table(x = worldreg_def,
              file = "dict/worldreg003_def.csv",
              fileEncoding = "UTF-8",
              sep = ";")
saveRDS(object = worldreg_def, file = "dict/worldreg003_def.RDS")
...
write.table(x = worldreg_dict,
              file = "dict/worldreg003_dict.csv",
              fileEncoding = "UTF-8",
              sep = ";")
saveRDS(object = worldreg_dict, file = "dict/worldreg003_dict.RDS")
...
ent_ctrl <- c("Q258",   # Republic of southern Africa
              ...
              "Q18760" )  # Europa League / UEFA

worldreg_ctrl <- extract_alias(ent_ctrl,c("fr","de","en","tr","ar"))
write.table(x = worldreg_ctrl,
              file = "dict/worldreg003_ctrl.csv",
              fileEncoding = "UTF-8",
              sep = ";")
saveRDS(object = worldreg_ctrl, file = "dict/worldreg003_ctrl.RDS")
...
## Control dictionary
ctrl<-readRDS("dict/worldreg003_ctrl.RDS")
...
## Target dictionary
dict<-readRDS("dict/worldreg003_dict.RDS")
...
qd_dict<-dictionary(qd_dict, tolower=F)
...
saveRDS(qd,"quanteda/corpus_worldreg_003.RDS")
table(qd$nbregs)
```
